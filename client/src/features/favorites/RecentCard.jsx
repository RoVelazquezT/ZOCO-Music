...
function RecentCard({ item, index = 0 }) {
  return (
    <article
      className="group flex items-center gap-4 overflow-hidden rounded-xl bg-white/5 p-0 backdrop-blur-sm transition-all duration-500 ease-[var(--ease-silk)] hover:bg-white/[0.08] hover:shadow-[var(--shadow-glow)]"
